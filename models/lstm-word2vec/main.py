...
########################################
def main(EMBEDDING_FILE, TRAIN_DATA_FILE, TEST_DATA_FILE, MAX_SEQUENCE_LENGTH, MAX_NB_WORDS, EMBEDDING_DIM, BATCH_SIZE, CV_SIZE, VALID_RATIO) :
  ...
  STAMP = 'tmp/lstm_%d_%d_%.2f_%.2f'%(num_lstm, num_dense, rate_drop_lstm, \
          rate_drop_dense)
...
if __name__ == "__main__":
  ...
  main(args.EMBEDDING_FILE, args.TRAIN_DATA_FILE, args.TEST_DATA_FILE, args.MAX_SEQUENCE_LENGTH, args.MAX_NB_WORDS, args.EMBEDDING_DIM, args.BATCH_SIZE, args.CV_SIZE, args.VALID_RATIO)
